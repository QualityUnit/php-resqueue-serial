...
class Resque_Job
{
	...
	/**
	 * @var object|Resque_Task Instance of the class performing work for this job.
	 */
	private $instance;
	 ...
	 * @return string
	 */
	public static function create($queue, $class, $args = null, $monitor = false, $id = null, $fails = 0)
	{
		if (is_null($id)) {
	 ...
	 *
	 * @return Resque_Task Instance of the object that this job belongs to.
	...
	public function getInstance()
	{
        ...
        $this->instance = $this->getTaskFactory()->create($this->payload['class'], $this->getArguments(), $this->queue);
