...
class Resque_Worker
{
	...
	*/
	 ...
	 * @return false|Resque_Worker Instance of the worker. False if the worker does not exist.
	 */
	 ...
	 * @return Resque_Queue wrapper around associated queues.
	 */
	public function queues($fetch = true)
	{
		if(!in_array('*', $this->queues) || $fetch == false) {
			return new Resque_Queue($this->queues);
		}

		$queues = Resque::queues();
		sort($queues);
		return new Resque_Queue($queues);
	}
